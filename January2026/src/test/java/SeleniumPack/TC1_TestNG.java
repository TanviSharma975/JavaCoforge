...
public class TC1_TestNG {
	
	WebDriver driver;
	
	String projectpath=System.getProperty("user.dir");
  @Test(dataProvider = "dp")
  public void f(String url,String username, String password) throws IOException, InterruptedException {
  ...
  public void verifyLogin() {
	  driver.get("https://mcdelivery.co.in/restaurants-nearby");
	  Login_POM obj=new Login_POM(driver);
	  obj.enterusername("Admin");
	  obj.enterpassword("admin123");
	  obj.clickonsubmit();
	  Assert.assertTrue(obj.dashboardisplayed());
  }
